    ...
    children=[
        html.Div(
            ...
            children=[
                ...
                html.H4(children="Heart Diseases cases in the US"),
                html.P(
                    id="description",
                    children="† Cases are classified using the International Classification of Diseases, \
                ...
                html.Div(
                    ...
                    children=[
                        ...
                        html.Div(
                            ...
                            children=[
                                html.P(
                                    "Heatmap of age adjusted mortality rates {0}".format(
                                        min(YEARS)
                                    ),
                                    id="heatmap-title",
                                ),
                    ...
                    children=[
                        ...
                        dcc.Dropdown(
                            options=[
                                ...
                                {
                                    "label": "Histogram of total number of deaths",
                                ...
                                {
                                    "label": "Trends in age-adjusted death rate",
